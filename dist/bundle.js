(function (exports, r, propTypes, reactIs) {
  'use strict';
  ...
  function getStatics(component) {
    ...
    if (reactIs__default["default"].isMemo(component)) {
      return MEMO_STATICS;
  ...
  function Message(_ref) {
    ...
    return /*#__PURE__*/r__default["default"].createElement(Container, {
      id: "message-".concat(date),
      key: "message-".concat(date),
      className: "".concat(type).concat(classes === null || classes === void 0 ? void 0 : classes.map(function (className) {
        return " ".concat(className);
      }))
    }, show ? /*#__PURE__*/r__default["default"].createElement("p", null, text) : '');
  }
